...
class ConfigManager:
    ...
    def load_hotkeys(self):
        return {
            ...
            "pause": self._hotkey_or_default(self.settings.value("hotkeys/pause", "f10"), "f10"),
            "kill": self._hotkey_or_default(self.settings.value("hotkeys/kill", "f12"), "f12"),
        }
    ...
    def save_hotkeys(self, hotkeys: dict):
        ...
        self.settings.setValue("hotkeys/pause", self._hotkey_or_default(hotkeys.get("pause"), defaults["pause"]))
        self.settings.setValue("hotkeys/kill", self._hotkey_or_default(hotkeys.get("kill"), defaults["kill"]))
