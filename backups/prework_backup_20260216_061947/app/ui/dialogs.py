...
class NotImageDialog(BaseDialog):
    ...
    def _init_groups(self):
        ...
        # Run Macro Group
        self.groupRunMacro = QGroupBox("Run Macro")
        runLayout = QHBoxLayout(self.groupRunMacro)
        self.edRunMacroPath = QLineEdit(self._default_macro_path())
        self.btnRunMacroBrowse = QPushButton("Browse...")
        self.btnRunMacroBrowse.clicked.connect(self._on_browse_run_macro)
        runLayout.addWidget(self.edRunMacroPath)
        runLayout.addWidget(self.btnRunMacroBrowse)
    ...
    def _refresh_visibility(self):
        ...
        for grp in [
            ...
            self.groupJumpIf, self.groupRunMacro
        ]:
