...
## 최신 검증 기준
- 전체 테스트: `python -m pytest -q` => `94 passed`
...
- `google_messages.py` was split into focused modules (`google_messages_base.py`, `google_messages_auth.py`, `google_messages_chat.py`, `google_messages_processing.py`) while keeping `GoogleMessagesPage` public API stable.
- Baseline verification: 94 passed.
